...
final class FileRepository extends EloquentRepository
{
    ...
    public function deleteByPath(string $path, ?string $storage = null): mixed
    {
        return $this->queryByPath($path, $storage)->delete();
    }
    ...
    public function findPathsByOrigin(string $origin): Collection
    {
        return $this->raw()
            ->where('origin', $origin)
            ->get()
    ...
    public function deleteByOrigin(string $origin): int
    {
        return $this->raw()
            ->where('origin', $origin)
            ->delete();
